---
title: 001_在 vuepress 中引入 markdown-it 插件
icon: 'markdown'
category: markdown
tag:
  - table
...
在书写[自动化控制原理相关表格](../../learningNote/Principles_of_Automatic_Control_Related/README.md#s-z变换表-table-of-s--and-z-transforms)时希望将表格进行合并，但是普通的Markdown并没有针对复杂表格的处理能力。

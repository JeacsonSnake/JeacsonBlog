...
🌱 I'm motivated to become an engineer who knows a bit of everything whether it's hardware or software, front-end or back-end, mechanical assembly to casing design, etc., I am currently studying for a postgraduate degree in Mechanical Engineering at the **Hong Kong University of Science and Technology**.
...
💬 Through self-study and university courses, I have learnt how to use computer languages such as JAVA/Python/JavaScript/HTML/CSS/C++/Objective-C to program on devices including, but not limited to, Raspberry Pi/ARDUINO/PCs. I really enjoy the process of constantly learning to create value, and I shall endeavour to continually improve my skills.
...
🐣 I am currently using knowledge relating to Large Language Models (LLMs), including but not limited to `Kimi Code` and `Hermes Agent`, to organise and expand upon my coding work on this blog. You can refer to [**my related blog posts**](../../postMortem/sp_for_LLM/README.md) to find out what I have been doing with LLMs (still mainly written in Chinese).
